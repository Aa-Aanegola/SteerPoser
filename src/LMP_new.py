...
class LMP:
    ...
    def __init__(self, name, cfg, fixed_vars, variable_vars, steer_cfg='./configs/steering.yaml', debug=False, env='rlbench'):
        self._name = name
        self._cfg = cfg
        self._debug = debug
    ...
    def _cached_api_call(self, **kwargs):
        ...
        if kwargs['model'] != 'gpt-3.5-turbo-instruct' and \
            ...
            if kwargs in self._cache:
                ...
                response = client.completions.create(**kwargs)['choices'][0]['text'].strip()
